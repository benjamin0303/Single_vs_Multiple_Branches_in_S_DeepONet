# Thermo-mechanical (coupled multiphysics) - multi-branch S-DeepONet / MIONet
#
# Code release for:
...
for idx , fraction_train in enumerate([ 0.8 ]):
        ...
        while(1):
                ...
                losshistory, train_state = model.train(iterations=310000, batch_size=batch_size, model_save_path="./Models/model_2br_"+str(count) )
                np.save('losshistory_2br'+str(count)+'.npy',losshistory)
        ...
        plt.savefig('Stress_Err_hist_2br'+str(idx)+'.jpg' , dpi=300)

        plt.hist( error_t.flatten() , bins=25 )
        plt.savefig('Temp_Err_hist_2br'+str(idx)+'.jpg' , dpi=300)
