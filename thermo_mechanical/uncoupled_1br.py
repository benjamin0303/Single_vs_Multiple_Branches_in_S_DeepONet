# Thermo-mechanical (uncoupled multiphysics) - single-branch S-DeepONet
#
# Code release for:
...
for idx , fraction_train in enumerate([ 0.8 ]):
        ...
        while(1):
                ...
                losshistory, train_state = model.train(iterations=110000, batch_size=batch_size, model_save_path="./Models/model_1br_"+str(count)) 
