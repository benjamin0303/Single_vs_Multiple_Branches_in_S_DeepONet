# Reaction-Diffusion (single physics) - multi-branch S-DeepONet / MIONet (GRU branches)
#
# Code release for:
...
for idx , fraction_train in enumerate([ 0.8 ]):
        ...
        while(1):
                ...
                branch = tf.keras.models.Sequential([
                         tf.keras.layers.GRU(units=256,batch_input_shape=(batch_size, m, 1),activation = my_act1,return_sequences = True, dropout=0.00, recurrent_dropout=0.00),
                ...
                np.savez_compressed('rd_test_results_2br_mionet.npz', grid=xy_train_testing,inputs_2br=u0_testing, pred_2br=Org_stress_pred, target_2br=Org_stress_test)
