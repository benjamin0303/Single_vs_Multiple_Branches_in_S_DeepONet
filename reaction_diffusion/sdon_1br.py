# Reaction-Diffusion (single physics) - single-branch S-DeepONet (GRU branch)
#
# Code release for:
...
for idx , fraction_train in enumerate([ 0.8 ]):
        ...
        while(1):
                ...
                np.savez_compressed('rd_test_results_1br.npz', grid=xy_train_testing,inputs_1br=u0_testing, pred_1br=Org_stress_pred, target_1br=Org_stress_test)
