# Reaction-Diffusion (single physics) - single-branch DeepONet (FNN branch)
#
# Code release for:
...
N_output_frame = 1 # One, predicting the last frame
...
for idx , fraction_train in enumerate([ 0.8 ]):
        ...
        while(1):
                ...
                branch = tf.keras.models.Sequential([
                        # Flatten input to (batch_size, Nx * 2) for dense layers
                            tf.keras.layers.Flatten(input_shape=(Nx, 2)),
                ...
                losshistory, train_state = model.train(iterations=110000, batch_size=batch_size, model_save_path="TrainFrac_"+str(idx) )
                ...
                np.savez_compressed('rd_fnn_test_results_1br.npz', grid=xy_train_testing,inputs_1br=u0_testing, pred_1br=Org_stress_pred, target_1br=Org_stress_test)
