# Thermo-electrical (coupled multiphysics) - multi-branch S-DeepONet / MIONet
#
# Code release for:
...
losshistory, train_state = model.train(
    iterations=310000, batch_size=batch_size, model_save_path="./Models/model_2br/model")
np.save('./Models/model_2br/losshistory.npy', losshistory)
...
np.savez('./Models/model_2br/predictions.npz', x_grid=data.test_x[1][:, 0],
